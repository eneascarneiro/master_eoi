...
public class Empresa{
    ...
    public Empresa(long id, String ciudad, String pais, String region, String codigo_postal, String telefono, String linea_direccion1, String linea_direccion2, List<Employee> empleados) {
        this.id = id;
        this.ciudad = ciudad;
        this.pais = pais;
        this.region = region;
